...
- U&M | Utility & Maintenance
  - Subservient Branch
    ...
    - Butler
    - Conductor
  - TTS | Technical Task Squad (Hazmat Unit)
- MD | Medical Department
  - PB | Psychology Branch
  - VP | Veterinarian Program
  - CM | Combat Medics
...
- FDC | Fort Defense Company
  ...
  - Central Complaints Branch
- OS | Outpost Superior (Also known as BC | Bayonet Company)
  - CBRN
  - Scout Snipers
...
- TS | Test Subject
  ...
  - HRTS | High Reputation Test Subject
- CIV | Civilians
...
- Solitary Confinement | Punishment team
- CIS Solitary | Punishment team
...
- U3 | Unit 3
- U4 | Unit 4
- CTZ | Containment Zone (Sector 3)
- TSCZ | Test Subject Containment Zone
- CISCZ | Contained Infected Subject Containment Zone (Unit 3)
- PS | Panic Shelter
- BM | Black Market
...
- The Special Operations has full authority over Unit 4 breaches and U4/Mass tests during all codes.
- RECON has full authority over Normal Infected Breaches and Base Tests during all codes.
- SO has full authority over Riots and Raids during all codes.
- SD has full authority over normal facility operations.

---

The phrase “ 10-2 “ is recognized as the official “ kill me “ phrase in Thunder Scientific Corporation. Anyone requesting it can be terminated freely by anyone at any circumstance without any consequence. Test subjects killing personnel requesting 10-2 are not deemed hostile as by D1.
